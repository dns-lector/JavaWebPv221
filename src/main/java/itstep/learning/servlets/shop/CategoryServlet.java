...
/*
Д.З. Впровадити до системи ролі користувачів
Розподілити різні ролі серед зареєстрованих користувачів
Обмежити виведення форми додавання нових категорій товарів
